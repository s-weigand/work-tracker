...
work-tracker could always use more documentation, whether as part of the
official work-tracker docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_work_tracker
